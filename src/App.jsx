    ...
    <div className="min-h-screen bg-[#050505] text-neutral-100 font-['Outfit'] antialiased selection:bg-white selection:text-black flex flex-col justify-between">
      ...
      <header className="border-b border-neutral-900 px-8 py-5 sticky top-0 bg-black/80 backdrop-blur-md z-50">
        <div className="max-w-6xl mx-auto flex justify-between items-center">
          <div
            className="text-xl font-bold tracking-tight cursor-pointer flex items-center gap-1.5"
            onClick={handleReset}
          >
            <span>RESUME</span>
      ...
      <main className="max-w-6xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-8 items-start grow w-full py-16">
        ...
        <section className="lg:col-span-5 bg-[#0A0A0A] border border-neutral-900 rounded-xl p-8 shadow-2xl relative">
          <div className="mb-8">
            ...
            <p className="text-xs text-neutral-500 mt-1 uppercase tracking-wider">
              Upload Profile & Fine-tune Metrics
            </p>
          </div>
              ...
              >
                ...
                {file ? (
                  <div className="space-y-1">
                    ...
                    <p className="text-xs text-neutral-500 truncate max-w-60 mx-auto">
                      {file.name}
                    </p>
                  </div>
                ) : (
        ...
        <section className="lg:col-span-7 bg-[#0A0A0A] border border-neutral-900 rounded-xl p-8 shadow-2xl min-h-125 flex flex-col justify-between">
          {/* STATE 1: INITIAL BLANK STATE */}
          {!isLoading && !results && (
            <div className="flex flex-col items-center justify-center my-auto text-center space-y-3 py-12">
              <div className="w-12 h-12 rounded-full border border-neutral-800 flex items-center justify-center text-neutral-600 text-lg">
                ?
              </div>
              <div className="max-w-xs">
                <p className="text-sm font-medium text-neutral-300">
                  Terminal Pipeline Standby
                </p>
                <p className="text-xs text-neutral-500 mt-1 leading-normal">
                  Configure variables and launch scanning sequence to yield
                  target structural reports.
                </p>
              </div>
            </div>
          )}
          ...
          {!isLoading && results && (
            <div className="space-y-6 mt-2 animate-[fadeIn_0.2s_ease-out]">
              ...
              <div className="flex flex-row justify-between items-center border-b border-neutral-900 pb-5 gap-4">
                <div>
                  <h3 className="text-xl font-semibold tracking-tight text-white capitalize">
                    {results.targetRole}
                  </h3>
                  <p className="text-xs font-medium text-neutral-500 tracking-wider mt-0.5 uppercase">
                    {results.level}
                  </p>
                </div>
              ...
              <div className="bg-neutral-900/20 border border-neutral-900 rounded-lg p-4">
                <h4 className="text-[10px] font-semibold tracking-widest text-neutral-500 uppercase mb-1.5">
                  Recruiter Breakdown
                </h4>
                ...
                <div className="border border-neutral-900 bg-[#0E0E0E]/40 rounded-lg p-5">
                  ...
                  <ul className="space-y-2.5">
                    {results.missingKeywords.map((kw, idx) => (
                      <li
                        key={idx}
                        className="text-xs text-neutral-400 font-medium flex items-center gap-2"
                      >
